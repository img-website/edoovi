...
<!-- hero section  -->
<section class="relative lg:h-full lg:pt-20 md:pt-28 sm:pt-32 pt-24 max-lg:pb-8 overflow-hidden">
                    ...
                    <div class='w-full aspect-square rounded-full bg-[#EFECFE] md:p-10 p-4 '>
                        <div class='w-full aspect-square rounded-full bg-[#DCD6FE] md:p-10 p-4 '>
                            <div class='w-full relative aspect-square rounded-full bg-[#9985FC] '>
                                <div class='w-full absolute inset-x-0 bottom-0 md:aspect-[12/14] aspect-[10/12] px-2 rounded-full flex items-end'>
...
<section class="relative py-2  overflow-hidden">
    <div class="relative container mx-auto max-w-7xl px-6 lg:px-8 z-10 sm:mb-10 ">
        <p class="max-md:text-2xl/tight max-xl:text-3xl/tight text-4xl/tight tracking-[-0.04em] text-slate-900  font-semibold" data-aos="fade-right" data-aos-duration="1000">
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8 w-full">
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 sm:gap-5  gap-3 py-5">
            <div class="col-auto" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div class="col-auto" data-aos="fade-up" data-aos-duration="1500">
            ...
            <div class="col-auto" data-aos="fade-up" data-aos-duration="2000">
...
<!-- logo section  -->
<div class="overflow-hidden sm:py-10 max-sm:pb-8 ">
    <div class="relative container mx-auto max-w-7xl px-6 lg:px-8 z-10 sm:mb-10 mb-7" data-aos="fade-right" data-aos-duration="1000">
...
<section class="relative md:pb-16 pb-10  ">
    ...
    <div class="relative container mx-auto max-w-7xl px-6 lg:px-8 z-10 sm:pb-10 pb-7" data-aos="fade-right" data-aos-duration="1000">
        <p class="max-md:text-2xl/tight max-xl:text-3xl/tight text-4xl/tight tracking-[-0.04em] text-slate-900  font-semibold">
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8 w-full relative z-10">
        <div class="grid grid-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            <div class="col-auto group" data-aos="flip-left" data-aos-duration="1000">
                <div class="size-full p-5 rounded-3xl bg-white  [box-shadow:0px_0px_32px_0px_rgba(36,40,46,.12)]   flex flex-col justify-center items-center text-center
                    ...
                    <div class="*:size-10 sm:*:size-14 group-hover:text-white ">
            ...
            <div class="col-auto group" data-aos="flip-up" data-aos-duration="1000">
                <div class="size-full p-5 rounded-3xl bg-white text-center [box-shadow:0px_0px_32px_0px_rgba(36,40,46,.12)]  flex flex-col justify-center items-center
                    group-hover:bg-gradient-to-b from-violet-300 to-violet-500/90 group-hover:border-transparent duration-300 transition-all 
                    group-hover:scale-95">
                    <div class="*:size-10 sm:*:size-14 group-hover:text-white *:[]">
...
<!-- card start -->
<section class="lg:pb-16 pb-10 overflow-x-hidden ">
        ...
        <div class="flex bg-violet-50 lg:py-10 py-6 flex-wrap px-5 lg:px-8 rounded-3xl">
            ...
            <div class="lg:w-1/2 w-full mt-4">
                <div class="flex  flex-wrap relative item-stretch">
                    <div class="w-1/2 h-auto sm:p-2 p-1" data-aos="fade-up" data-aos-duration="1000">
                        <div class="flex  justify-center h-full items-center flex-col hover:translate-y-1 duration-300 bg-gradient-to-b from-slate-500 to-slate-900   rounded-xl sm:rounded-3xl group shadow-2xl sm:p-6 p-4 relative">
                            <div class="sm:*:size-1o *:size-8 text-white mb-2 ">
                                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="200px" width="200px" xmlns="http://www.w3.org/2000/svg">
                                    <path fill="none" stroke-width="1.5px" d="M10.3248685,14.7630919 C7.82620532,14.038202 6,11.7325889 6,9 L6,1 L18,1 L18,10 M6,3 L1,3 L1,7 C1,9.509 2.791,11 5,11 L6,11 M20.0335555,10.884915 C21.7416567,10.4908882 23,9.10306372 23,7 L23,3 L18,3 M10,19 L5,19 L5,23 L16.5,23 M16.5,10 C12.9101429,10 10,12.9101429 10,16.5 C10,20.0898571 12.9101429,23 16.5,23 C20.0898571,23 23,20.0898571 23,16.5 C23,12.9101429 20.0898571,10 16.5,10 L16.5,10 Z M20,14 L15.5,18.5 L13,16 M10.2056405,15.4240751 C8.89754812,16.0817472 8,17.4360568 8,19"></path>
                                </svg>
                            </div>
                    ...
                    <div class="w-1/2 h-auto sm:p-2 p-1" data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <div class="w-1/2 h-auto sm:p-2 p-1" data-aos="fade-left" data-aos-duration="1000">
                        <div class="flex  justify-center h-full items-center flex-col hover:translate-y-1 duration-300 bg-white text-gray-700   rounded-xl sm:rounded-3xl group shadow-2xl sm:p-6 p-4 relative
                               ">
                            <div class="*:sm-size-12 *:size-8  mb-2 ">
                    ...
                    <div class="w-1/2 h-auto sm:p-2 p-1" data-aos="fade-down" data-aos-duration="1000">
    ...
    <div class="  mx-auto max-w-7xl px-6 lg:px-8">
        <div class="relative sm:py-14 py-10 isolate  text-center justify-center :relative :z-10 bg-gray-900/70 px-6 shadow-2xl rounded-2xl sm:rounded-3xl sm:px-16 lg:flex lg:px-24">
            ...
            <div class=" gap-x-7 max-sm:gap-0 flex items-center max-lg:flex-col-reverse">
                <div data-aos="fade-right" data-aos-duration="1000" class="lg:w-6/12 w-full relative z-20 h-auto shrink-1 grow-0 sm:py-8 max-lg:pt-0 max-lg:px-10 max-sm:px-0">
                ...
                <div data-aos="fade-left" data-aos-duration="1000" class="lg:w-5/12 w-full relative z-10 ms-auto max-lg:px-10 max-sm:px-2">
...
<section class="relative overflow-hidden lg:pb-16 sm:pb-10 pb-8">
    ...
    <div class="relative container mx-auto max-w-7xl z-10  lg:px-10 px-6" data-aos="fade-right" data-aos-duration="1000">
    ...
    <div class="container mx-auto max-w-7xl px-6 lg:px-8  sm:px-6 ">
        ...
        <div class="relative pb-8 md:p-5 md:px-10">
            <div class="relative z-10 lg:grid lg:grid-cols-12 lg:items-cente mt-5">
                <div class="mb-5 sm:mb-10 lg:mb-0 lg:col-span-7 lg:order-2 bg-purple-50 px-4 sm:px-8 md:px-16 py-5 sm:py-8 md:py-12 rounded-3xl">
                    ...
                    <nav class="grid gap-4 mt-5 md:mt-10" aria-label="Tabs" role="tablist" aria-orientation="vertical">
                        <button data-aos="fade-left" data-aos-duration="1000" type="button" class="text-start hover:bg-white shadow-xl focus:outline-none  p-4 md:px-6 md:py-8 rounded-3xl active bg-white border-transparent text-blue-600" id="tabs-with-card-item-1" aria-selected="true" data-hs-tab="#tabs-with-card-1" aria-controls="tabs-with-card-1" role="tab">
                        ...
                        <button data-aos="fade-left" data-aos-duration="1000" type="button" class="text-start hover:bg-white shadow-xl focus:outline-none  p-4 md:px-6 md:py-8 rounded-3xl" id="tabs-with-card-item-2" aria-selected="false" data-hs-tab="#tabs-with-card-2" aria-controls="tabs-with-card-2" role="tab">
                            <span class="flex gap-x-6 gap-y-4 sm:gap-y-0 items-center sm:items-start text-center sm:text-start flex-col sm:flex-row">
                        ...
                        <button data-aos="fade-left" data-aos-duration="1000" type="button" class="text-start hover:bg-white shadow-xl focus:outline-none  p-4 md:px-6 md:py-8 rounded-3xl" id="tabs-with-card-item-3" aria-selected="false" data-hs-tab="#tabs-with-card-3" aria-controls="tabs-with-card-3" role="tab">
                            <span class="flex gap-x-6 gap-y-4 sm:gap-y-0 items-center sm:items-start text-center sm:text-start flex-col sm:flex-row">
                        ...
                        <button data-aos="fade-left" data-aos-duration="1000" type="button" class="text-start hover:bg-white shadow-xl focus:outline-none  p-4 md:px-6 md:py-8 rounded-3xl" id="tabs-with-card-item-4" aria-selected="false" data-hs-tab="#tabs-with-card-4" aria-controls="tabs-with-card-4" role="tab">
                            <span class="flex gap-x-6 gap-y-4 sm:gap-y-0 items-center sm:items-start text-center sm:text-start flex-col sm:flex-row">
                ...
                <div class="lg:col-span-5 lg:-mr-5" data-aos="zoom-in" data-aos-duration="1000">
                    <div class="relative">
                        <div>
...
<section class="container px-6 lg:px-8 mx-auto max-w-7xl lg:pb-16 pb-10 overflow-hidden">
    <div class="relative z-10 mb-8 md:mb-12" data-aos="fade-right" data-aos-duration="1000">
        ...
        <div class="md:text-base text-sm text-black/70 my-2 font-semibold text-balance ">
            ...
            <div class="col-span-12 sm:col-span-6 md:col-span-4 lg:col-span-6 lg:row-span-2" data-aos="zoom-in" data-aos-duration="1000">
                <div class="relative size-full rounded-3xl p-4  max-sm:[box-shadow:0px_0px_32px_0px_rgba(36,40,46,.12)] sm:hover:[box-shadow:0px_0px_32px_0px_rgba(36,40,46,.12)]">
                    ...
                    <div class="text-box  ">
                        ...
                        <div class="pt-2 lg:pt-4">
                            <a class="text-sm lg:text-base flex items-center  gap-1 group before:absolute before:inset-0 before:z-10 font-semibold" href="./blogs/bloginner">Read more
                                <div class="group-hover:translate-x-2 duration-300 *:size-4">
                                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 320 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z"></path>
                                    </svg>
    ...
    <div class="mx-auto max-w-7xl lg:px-8 px-6">
        <div class="flex justify-center items-center relative z-10">
            ...
            <div class="">
                ...
                <div class="w-full sm:p-8 p-5 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-64 mr-auto rounded-2xl shadow-2xl bg-white">
                    <div class="flex">
                    ...
                    <div class="my-2 sm:w-1/2 lg:w-1/4 sm:mx-auto flex items-center justify-center">
