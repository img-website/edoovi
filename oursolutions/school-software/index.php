                ...
                <ul class="flex gap-8">
                    ...
                    <li class="relative group">
                        ...
                        <div class="bg-white  shadow-md border-gray-100 z-50 border translate-y-10  opacity-0 invisible duration-300 !w-60 absolute group-hover:translate-y-0  group-hover:opacity-100 group-hover:visible">
                            <ul>
                                <li class="">
                                    <a class="active [&.active]:text-slate-950 [&.active]:border-b-[2px] [&.active]:border-b-slate-900 hover:bg-violet-400 w-full duration-300 text-slate-600 font-semibold px-4 py-2 hover:text-white border-b border-slate-200 inline-flex " href="">School Software</a>
                                </li>
                                <li class="">
                ...
                <div class=" flex flex-col  border-l h-[100vh]  overflow-hidden sm:w-1/2">
                    ...
                    <div class="flex flex-col bg-white pb-40   h-screen overflow-y-auto !content-between">
                        <ul xlass="h-max bg-white">
                            ...
                            <li class="w-full">
                                <a class="hover:bg-violet-400 duration-300 text-slate-600 font-semibold px-4 py-2 hover:text-white border-b border-slate-200 w-full inline-flex" href="">School Software</a>
                            </li>
