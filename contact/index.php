                ...
                <div class=" flex flex-col  border-l h-[100vh]  overflow-hidden sm:w-1/2">
                    ...
                    <div class="flex flex-col bg-white pb-40   h-screen overflow-y-auto !content-between">
                        ...
                        <div class="flex overflow-hidden justify-between py-5 px-4 rotate-180 bg-white w-full">
                                <a href="" class="text-nowrap bg-gradient-to-b from-violet-300 to-violet-500/90 py-2 px-4 rounded-full shadow-xl shadow-violet-200/95 font-medium sm:text-base text-sm text-white duration-300 hover:[box-shadow:0px_0px_10px_0px_#e39943] hover:bg-gradient-to-r hover:from-[#fdad50] hover:via-[#ffa944] hover:to-[#ff971d]">Contact Us</a>
            ...
            <div class="flex justify-center items-center relative z-10">
                ...
                <div class="">
                    ...
                    <div class="w-full sm:p-8 p-5 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-64 mr-auto rounded-2xl shadow-2xl bg-white">
                        ...
                        <div class="my-2 w-1/2 sm:lg:w-1/4 max-sm:mx-auto flex items-center justify-center">
