            ...
            <div class="lg:col-span-2">
                <div class="py-8 lg:pe-8">
                    <div class="space-y-5 lg:space-y-8">
                            ...
                            <div class="grid lg:grid-cols-2 gap-3">
                                <div class="grid grid-cols-2 lg:grid-cols-1 gap-3">
                                    <figure class="relative w-full h-60">
                                        <img class="size-full absolute top-0 start-0 object-cover rounded-xl" src="../../assets/img/blogInner01.jpg" alt="Blog Image">
                                    </figure>
                                    <figure class="relative w-full h-60">
                                        <img class="size-full absolute top-0 start-0 object-cover rounded-xl" src="../../assets/img/blogInner02.jpg" alt="Blog Image">
                                    </figure>
                                </div>
                                <figure class="relative w-full h-72 sm:h-96 lg:h-full">
                                    <img class="size-full absolute top-0 start-0 object-cover rounded-xl" src="../../assets/img/blogInner03.jpg" alt="Blog Image">
                                </figure>
                            </div>
                        </div>
                        ...
                        <figure>
                            <img class="w-full object-cover rounded-xl" src="../../assets/img/blogInner04.jpg" alt="Blog Image">
                        </figure>
                    ...
                    <div class="space-y-6">
                        <a class="group flex items-center gap-x-6 focus:outline-none" href="#">
                            ...
                            <div class="shrink-0 relative rounded-lg overflow-hidden size-20">
                                <img class="size-full absolute top-0 start-0 object-cover rounded-lg" src="../../assets/img/blog1.png" alt="Blog Image">
                            </div>
                        </a>
                        ...
                        <a class="group flex items-center gap-x-6 focus:outline-none" href="#">
                            ...
                            <div class="shrink-0 relative rounded-lg overflow-hidden size-20">
                                <img class="size-full absolute top-0 start-0 object-cover rounded-lg" src="../../assets/img/blog2.jpg" alt="Blog Image">
                            </div>
                        </a>
                    </div>
                </div>
