    ...
    <div class="max-w-7xl mx-auto py-3 px-6 lg:px-8 flex items-center justify-between">
        ...
        <div class="md:flex items-center gap-8 hidden">
            <ul class="flex gap-8">
                ...
                <li>
                <a href="<?php echo f_path ?>about" 
                class="inline-flex font-medium text-base
                     <?php echo basename($_SERVER['REQUEST_URI']) == 'about' ? 'text-red-600 border-b-2 border-red-600' : ''; ?>">
                        About Us
                    </a>
                </li>
                <li class="relative group">
                    <a href="<?php echo f_path ?>oursolutions/school-software" class="flex items-center font-medium text-base text-slate-600 <?php echo basename($_SERVER['PHP_SELF']) == 'school-software.php' ? 'text-red-600 border-b-2 border-red-600' : ''; ?>">
                        Our Solutions
                        <span class="*:size-6 *:group-hover:rotate-180 *:duration-300">
                            <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="200px" width="200px" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12 15.0006L7.75732 10.758L9.17154 9.34375L12 12.1722L14.8284 9.34375L16.2426 10.758L12 15.0006Z"></path>
                    ...
                    <div class="bg-white shadow-md border-gray-100 z-50 border translate-y-10 opacity-0 invisible duration-300 !w-60 absolute group-hover:translate-y-0 group-hover:opacity-100 group-hover:visible">
                        <ul>
                            <li>
                                <a href="<?php echo f_path ?>oursolutions/school-software" class="inline-flex font-medium text-base
                     <?php echo basename($_SERVER['REQUEST_URI']) == 'oursolutions/school-software' ? 'text-red-600 border-b-2 border-red-600' : ''; ?>">
                                    School Software
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo f_path ?>oursolutions/institute-software" class="hover:bg-violet-400 w-full duration-300 text-slate-600 font-semibold px-4 py-2 hover:text-white border-b border-slate-200 inline-flex <?php echo basename($_SERVER['PHP_SELF']) == 'institute-software.php' ? 'text-red-600 border-b-2 border-red-600' : ''; ?>">
                                    Institute Software
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo f_path ?>oursolutions/college-software" class="hover:bg-violet-400 w-full duration-300 text-slate-600 font-semibold px-4 py-2 hover:text-white border-b border-slate-200 inline-flex <?php echo basename($_SERVER['PHP_SELF']) == 'college-software.php' ? 'text-red-600 border-b-2 border-red-600' : ''; ?>">
                                    College Software
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo f_path ?>oursolutions/university-software" class="hover:bg-violet-400 w-full duration-300 text-slate-600 font-semibold px-4 py-2 hover:text-white border-b border-slate-200 inline-flex <?php echo basename($_SERVER['PHP_SELF']) == 'university-software.php' ? 'text-red-600 border-b-2 border-red-600' : ''; ?>">
                                    University Software
                                </a>
                            </li>
                        </ul>
                ...
                <li>
                    <a href="<?php echo f_path ?>blogs" class="inline-flex font-medium text-base text-slate-600 <?php echo basename($_SERVER['PHP_SELF']) == 'blogs.php' ? 'text-red-600 border-b-2 border-red-600' : ''; ?>">
                        Blogs
                    </a>
                </li>
                <li>
                    <a href="<?php echo f_path ?>clients" class="inline-flex font-medium text-base text-slate-600 <?php echo basename($_SERVER['PHP_SELF']) == 'clients.php' ? 'text-red-600 border-b-2 border-red-600' : ''; ?>">
                        Clients
                    </a>
                </li>
            </ul>
