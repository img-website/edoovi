        ...
        <div class="Edoovipx-4 mx-auto px-6 lg:px-8 max-w-7xl">
            <div class="grid grid-cols-1  sm:grid-cols-2 md:grid-cols-3 md:gap-y-16 gap-y-10 gap-x-12">
                <div class=" lg:pr-8 *:inline-block">
                    <a href="<?php echo f_path ?>">
                        <img class="w-auto h-16" src="<?php echo f_path ?>assets/img/edoovi.webp" alt="" />
                    </a>
                ...
                <div class="md:ms-auto">
                    ...
                    <ul class=" mt-6 flex flex-col gap-3">
                        <li class="flex items-center gap-2 group">
                            ...
                            <a href="<?php echo f_path ?>about/" title="" class="flex sm:text-base text-sm text-white transition-all duration-200 hover:text-orange-500 focus:text-orange-500"> About Edoovi </a>
                        </li>
                        ...
                        <li class="flex items-center gap-2 group">
                            ...
                            <a href="<?php echo f_path ?>clients/" title="" class="flex sm:text-base text-sm text-white transition-all duration-200 hover:text-orange-500 focus:text-orange-500"> Clients </a>
                        </li>
                        ...
                        <li class="flex items-center gap-2 group">
                            ...
                            <a href="<?php echo f_path ?>privacy-policy/" title="" class="flex sm:text-base text-sm text-white transition-all duration-200 hover:text-orange-500 focus:text-orange-500">Privacy Policy </a>
                        </li>
                        ...
                        <li class="flex items-center gap-2 group">
                            ...
                            <a href="<?php echo f_path ?>terms-conditions/" title="" class="flex sm:text-base text-sm text-white transition-all duration-200 hover:text-orange-500 focus:text-orange-500"> Terms Of Use </a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="md:ms-auto">
                    ...
                    <ul class=" mt-6 flex flex-col gap-3">
                        ...
                        <li class="flex items-center gap-2 group">
                            ...
                            <a href="<?php echo f_path ?>oursolutions/school-software/" title="" class="flex sm:text-base text-sm text-white transition-all duration-200 hover:text-orange-500 focus:text-orange-500"> School Software </a>
                        </li>
                        ...
                        <li class="flex items-center gap-2 group">
                            ...
                            <a href="<?php echo f_path ?>oursolutions/college-software/" title="" class="flex sm:text-base text-sm text-white transition-all duration-200 hover:text-orange-500 focus:text-orange-500"> College Software </a>
                        </li>
                        ...
                        <li class="flex items-center gap-2 group">
                            ...
                            <a href="<?php echo f_path ?>oursolutions/university-software/" title="" class="flex sm:text-base text-sm text-white transition-all duration-200 hover:text-orange-500 focus:text-orange-500"> University Software </a>
                        </li>
                        <li class="flex items-center gap-2 group">
                            <span class="relative flex h-3 w-3">
                                <span class="animate-ping absolute inline-flex h-full w-full rotate-45 bg-violet-500 opacity-75"></span>
                            ...
                            <a href="<?php echo f_path ?>blogs/" title="" class="flex sm:text-base text-sm text-white transition-all duration-200 hover:text-orange-500 focus:text-orange-500"> Blogs </a>
                        </li>
                    </ul>
                </div>
